...
if(! wp_verify_nonce($nonce_Key, 'csvimp_nonce'))
die('You are not allowed to do this operation.Please contact your admin.');
?>
<div id="ShowMsg" style="display:none;"><p id="setting-msg" class="alert alert-success"><?php echo esc_html__('Settings Saved', 'csv-import'); ?></p>
</div>
...
<form class="add:the-list: validate" style = "width:98%;" action="" name="importerSettings" method="post" enctype="multipart/form-data">
        <span><label class="activemenu"><?php echo esc_html__('General Settings','csv-import'); ?></label></span>
...
<br>
<button class="btnn btn-primary" onclick="saveSettings();" style="margin-left:7px;padding:5px;" value="Save" name="savesettings" type="submit"><?php echo esc_html__('Save Changes','csv-import'); ?> </button>
<p style ="padding-top:20px;">
<label class="activemenu"><?php echo esc_html__('Security and Performance','csv-import'); ?></label>
</p>
