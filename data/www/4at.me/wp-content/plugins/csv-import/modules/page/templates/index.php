...
?>
	...
	<!-- The global progress bar -->
        <div class="form-group" style="padding-bottom:20px;">
                                ...
                                <input type='submit' name='importfile' id='importfile' title = '<?php echo esc_attr__("Next",'csv-import'); ?>' value='<?php echo $impCE->reduceStringLength(esc_attr__("Next",'csv-import'),'Next'); echo esc_attr__(" >>");?>' disabled
