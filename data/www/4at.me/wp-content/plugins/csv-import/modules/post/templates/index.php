...
?>
	...
	<!-- The global progress bar -->
          <div class="form-group" style="padding-bottom:20px;">
                                ...
                                <input type='button' name='clearform' id='clearform' title = '<?php echo esc_attr__("Clear",'csv-import'); ?>' value='<?php echo $impCE->reduceStringLength(esc_attr__("Clear",'csv-import'),'Clear'); ?>' onclick="Reload();" class='btn btn-warning' style="margin-right:15px;"/>
                          
                               <input type='submit' name='importfile' id='importfile' title = '<?php echo esc_attr__("Next",'csv-import'); ?>' value='<?php echo $impCE->reduceStringLength(esc_attr__("Next",'csv-import'),'Next');?> >>' disabled  class='btn btn-primary' style="margin-right:15px;"/>
                                </div>
                                </tr>
                                </table>
...
?>
		...
		<input type='button' id='clear_mapping' class='clear_mapping btn btn-warning' name='clear_mapping' title = '<?php echo esc_attr__("Reset",'csv-import'); ?>' value='<?php echo esc_attr__('Reset','csv-import'); ?>' onclick='clearMapping();' style = 'float:left'/>
		</div>
 ...
 <div id='importrightaway' style='display:block'>
		...
		<label id="innertitle"><?php echo esc_html__('Inline image options','csv-import'); ?></label><br />
		...
		<input id="startbutton" class="btn btn-primary" type="button" value="<?php echo esc_attr__('Import Now','csv-import'); ?>" style="color: #ffffff;background:#2E9AFE;" onclick="importRecordsbySettings('<?php echo site_url(); ?>');" >
