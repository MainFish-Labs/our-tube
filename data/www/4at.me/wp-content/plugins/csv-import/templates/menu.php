...
$menuHTML .="<li  class = '".sanitize_html_class($dashboard)."' ><a href='".esc_url(add_query_arg(array('page' => WP_CONST_CSV_IMP_SLUG .'/index.php','__module' => 'dashboard'),$impObj->currentUrl))."'/>".esc_html__('Dashboard','csv-import')."</a></li>";
$menuHTML .="<li  class = '".sanitize_html_class($post)."' ><a href='".esc_url(add_query_arg(array('page' => WP_CONST_CSV_IMP_SLUG .'/index.php','__module' => 'post','step'=>'uploadfile'),$impObj->currentUrl))."'/>".esc_html__('Post','csv-import')."</a></li>";
$menuHTML .="<li  class = '".sanitize_html_class($page)."' ><a href='".esc_url(add_query_arg(array('page' => WP_CONST_CSV_IMP_SLUG .'/index.php','__module' => 'page','step'=>'uploadfile'),$impObj->currentUrl))."'/>".esc_html__('Page','csv-import')."</a></li>";
$menuHTML .="<li  class = '".sanitize_html_class($custompost)."' ><a href='".esc_url(add_query_arg(array('page' => WP_CONST_CSV_IMP_SLUG .'/index.php','__module' => 'custompost','step'=>'uploadfile'),$impObj->currentUrl))."'/>".esc_html__('CustomPost','csv-import')."</a></li>";
$menuHTML .="<li  class = '".sanitize_html_class($settings)."' ><a href='".esc_url(add_query_arg(array('page' => WP_CONST_CSV_IMP_SLUG .'/index.php','__module' => 'settings'),$impObj->currentUrl))."'/>".esc_html__('Settings','csv-import')."</a></li></ul>";
$menuHTML .= "</div>";
$menuHTML .= "<div class='msg' id = 'showMsg' style = 'display:none;'></div>";
$menuHTML .= "<input type='hidden' id='current_url' name='current_url' value='" . get_admin_url() . "admin.php?page=" . WP_CONST_CSV_IMP_SLUG . "/index.php&__module=" . sanitize_text_field($_REQUEST['__module']) . "&step=uploadfile'/>";
